...
El fichero scriptCarrito:
    a. Comprueba cuando se carga que el usuario tiene las cookies
    habilitadas y muestra un aviso si no es así.
    b. Inicializa el objeto Usuario con los datos del usuario actual, calcula el
